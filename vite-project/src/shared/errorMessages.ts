...
const ruleErrors = new Set<MessageKey>(['opponentAlreadyUsed', 'portraitInvalid', 'portraitsInvalid', 'firstPickLocked', 'playerMissing', 'usedByPlayer', 'usedByTeam', 'gameAlreadyCommitted', 'completeDraftFirst', 'commitBeforeNext', 'updateScoreBeforeNext', 'seriesHasEnded', 'swapOnlyBetweenGames', 'committedDraftReset', 'rulesLocked', 'duplicatePlayerIds', 'rosterLocked']);
